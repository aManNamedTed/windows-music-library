#ifndef "WINMUSLIB" //remember to add #include "winmuslib.h" in your music files
#define "WINMUSLIB"

#include <windows.h> // This library is only available for Windows machines!
#include <unistd.h>
...
// C# / Db - includes C#0 to C#8 or Db0 to Db8 (length is in milliseconds)
...
// D# / Eb - includes D#0 to D#8 or Eb0 to Eb8 (length is in milliseconds)
...
// F# / Gb - includes F#0 to F#8 or Gb0 to Gb8 (length is in milliseconds)
...
// G# / Ab - includes G#0 to G#8 or Ab0 to Ab8 (length is in milliseconds)
...
// A# / Bb - includes A#0 to A#8 or Bb0 to Bb8 (length is in milliseconds)
