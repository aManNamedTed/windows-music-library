...
void rst(double length) { Beep(00.00,   length); }

//			   C  - includes C0 to C8 (length is in milliseconds)
void cn0(double length)  { Beep(16.35,   length); }
void cn1(double length)  { Beep(32.70,   length); }
void cn2(double length)  { Beep(65.41,   length); }
void cn3(double length)  { Beep(130.81,  length); }
void cn4(double length)  { Beep(261.63,  length); }
void cn5(double length)  { Beep(523.25,  length); }
...
void dn0(double length)  { Beep(18.35, 	length); }
void dn1(double length)  { Beep(36.71,   length); }
void dn2(double length)  { Beep(73.42,   length); }
void dn3(double length)  { Beep(146.83,  length); }
void dn4(double length)  { Beep(293.66,  length); }
void dn5(double length)  { Beep(587.33,  length); }
